...
import '../styles/HeaderMenu.css'; // Fichier CSS correspondant
  ...
  return (
    <div className="header-menu">
      ...
      <ul className={`menu-items ${menuOpen ? 'open' : ''}`}>
        ...
        ><svg xmlns="http://www.w3.org/2000/svg" height=".9em" viewBox="0 0 512 512" fill="#F5F5DC">
        ...
        <li
          className={activePage === 'Article' ? 'active' : ''}
          onClick={() => handlePageChange('Article')}
        ><svg xmlns="http://www.w3.org/2000/svg" height=".9em" viewBox="0 0 576 512" fill="#F5F5DC">
